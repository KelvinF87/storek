...
export default function NavBar() {
  ...
  const toggleCart = () => {
    ...
    setCartKey((prevKey) => prevKey + 1); // Cambiar la clave para forzar la actualización
  };
  ...
  return (
    <Disclosure as="nav" className="bg-gray-800">
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <Menu as="div" className="relative ml-3">
              <MenuItems transition className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 ring-1 shadow-lg ring-black/5 transition focus:outline-none data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[enter]:ease-out data-[leave]:duration-75 data-[leave]:ease-in">
                <MenuItem>
      ...
      <ShoppingCartModal key={cartKey} isOpen={isCartOpen} onClose={toggleCart} />
